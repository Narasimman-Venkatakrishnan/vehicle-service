...
public class VehiclesControllerTest {
    ...
    public void testRetrieveAllVehicles() throws Exception {
        ...
        ResponseEntity<String> response = restTemplate.exchange(createURLWithPort("/shopping/cart/vehicles"), HttpMethod.GET, entity, String.class);
    ...
    public void testRetrieveVehicleByValidVehicleId() throws Exception {
        HttpEntity<String> entity = new HttpEntity<String>(null, headers);
        ResponseEntity<String> response = restTemplate.exchange(createURLWithPort("/shopping/cart/vehicles/55"), HttpMethod.GET, entity, String.class);
    ...
    public void testRetrieveDetailsByValidVehicleId() throws Exception {
        HttpEntity<String> entity = new HttpEntity<String>(null, headers);
        ResponseEntity<String> response = restTemplate.exchange(createURLWithPort("/shopping/cart/vehicles/80/details"), HttpMethod.GET, entity, String.class);
    ...
    public void testRetrieveVehicleByInvalidVehicleId() throws Exception {
        HttpEntity<String> entity = new HttpEntity<String>(null, headers);
        ResponseEntity<String> response = restTemplate.exchange(createURLWithPort("/shopping/cart/vehicles/800"), HttpMethod.GET, entity, String.class);
    ...
    public void testRetrieveDetailsByInvalidVehicleId() throws Exception {
        HttpEntity<String> entity = new HttpEntity<String>(null, headers);
        ResponseEntity<String> response = restTemplate.exchange(createURLWithPort("/shopping/cart/vehicles/800/details"), HttpMethod.GET, entity, String.class);
        assertTrue(response.getStatusCode().is4xxClientError());
    }
